...
import com.halfacode.japserreport.service.report.ReportService;
import com.halfacode.japserreport.service.transaction.TransactionService;
...
public class ReportController implements ReportApi {
  ...
  @Override
  public ResponseEntity<Void> downloadSrp(ExportType exportType, HttpServletResponse response) throws IOException, JRException {
    transactionService.exportTransactionReportSrp(exportType, response);
    return ResponseEntity.ok().build();
  }
}
