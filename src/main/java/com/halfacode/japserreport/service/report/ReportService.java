...
public class ReportService {
  ...
  private List<InspectionItemDto> getStaticData() {

    return List.of(
            new InspectionItemDto(1, "وجود مواقف سيارات", "MATCHED", "سكني", 1),
            new InspectionItemDto(2, "عدم وجود مخالفات", "NOT_MATCHED", "سكني", 1),
            new InspectionItemDto(3, "توفر طفايات حريق", "MATCHED", "تجاري", 2)
    );
  }
}
