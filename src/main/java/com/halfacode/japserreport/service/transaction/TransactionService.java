package com.halfacode.japserreport.service.transaction;

import com.halfacode.japserreport.domain.TransactionFilter;
...
import com.halfacode.japserreport.service.report.dynamic.DynamicReportService;
...
public class TransactionService {
  ...
  public void exportTransactionReportSrp(ExportType exportType, HttpServletResponse response) throws JRException, IOException {
    var filter = new TransactionFilter(exportType);
    var inputStream = filter.getInputStream();
    var title = filter.getReportTitle();
    var list = getTransactionList();
