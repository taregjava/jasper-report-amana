...
import com.jamilxt.java_springboot_japserreport.service.report.PostFoundationCastingStageReportService;
...
public class PostFoundationCastingStageReportController {
    ...
    @GetMapping(path = "/post-foundation/sample/pdf", produces = MediaType.APPLICATION_PDF_VALUE)
    public void postFoundationSamplePdf(HttpServletResponse response) throws Exception {
