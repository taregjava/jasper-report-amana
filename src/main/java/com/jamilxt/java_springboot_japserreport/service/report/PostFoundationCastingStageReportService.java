...
public class PostFoundationCastingStageReportService {
    ...
    public PostFoundationCastingStageReportService(ResourceLoader resourceLoader) {
...
// imports omitted for brevity (JasperCompileManager, JasperFillManager, JasperExportManager, JRBeanCollectionDataSource, JasperReport, JasperPrint, etc.)
    ...
    public byte[] generatePostFoundationPdfStatic() throws Exception {
        ...
        try (InputStream headerIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_report_header.jrxml");
             InputStream ownerIs  = getClass().getResourceAsStream("/report/postFoundation/post-foundation_report_owner.jrxml");
             InputStream bodyIs   = getClass().getResourceAsStream("/report/postFoundation/post-foundation_report_body.jrxml");
             InputStream buildingIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_report_building.jrxml");
             InputStream tableIs  = getClass().getResourceAsStream("/report/postFoundation/post-foundation_report_table.jrxml");
             InputStream photosIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_report_photos.jrxml");
             InputStream sitePhotosIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_site_photos_page.jrxml");
             InputStream photosTopGridIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_report_photos_top_grid.jrxml");
             InputStream photosBottomGridIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_report_photos_bottom_grid.jrxml");
             InputStream footerIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_shared_footer.jrxml");
             InputStream mainImagesIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_main_images.jrxml");
             InputStream changesRowsIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_changes_rows.jrxml");
             InputStream changesPageIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_changes_page.jrxml");
             InputStream inspectionResponsibilityIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_inspection_responsibility.jrxml");
             InputStream masterIs = getClass().getResourceAsStream("/report/postFoundation/post-foundation_report_master.jrxml")) {
    ...
    public byte[] generatePdf(ProjectStartReportDto dto) throws JRException {
        try (InputStream headerIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_report_header.jrxml").getInputStream();
             InputStream ownerIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_report_owner.jrxml").getInputStream();
             InputStream bodyIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_report_body.jrxml").getInputStream();
             InputStream buildingIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_report_building.jrxml").getInputStream();
             InputStream tableIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_report_table.jrxml").getInputStream();
             InputStream photosIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_report_photos.jrxml").getInputStream();
             InputStream sitePhotosIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_site_photos_page.jrxml").getInputStream();
             InputStream photosTopGridIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_report_photos_top_grid.jrxml").getInputStream();
             InputStream photosBottomGridIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_report_photos_bottom_grid.jrxml").getInputStream();
             InputStream footerIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_shared_footer.jrxml").getInputStream();
             InputStream mainImagesIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_main_images.jrxml").getInputStream();
             InputStream changesRowsIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_changes_rows.jrxml").getInputStream();
             InputStream changesPageIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_changes_page.jrxml").getInputStream();
             InputStream inspectionResponsibilityIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_inspection_responsibility.jrxml").getInputStream();
             InputStream masterIs = resourceLoader.getResource("classpath:report/postFoundation/post-foundation_report_master.jrxml").getInputStream()) {
            ...
            throw new JRException("Failed to generate post-foundation casting stage report", e);
        }
    }
